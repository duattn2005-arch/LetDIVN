      ...
      >
        ...
        <div className="p-6">
          ...
          <div className="space-y-2.5 mb-5">
            {inAppBrowser ? (
              <div className="flex items-start gap-2 bg-amber-50 border border-amber-200 rounded-xl p-3 text-[11px] text-amber-800 leading-relaxed">
                <AlertCircle className="w-4 h-4 text-amber-500 shrink-0 mt-0.5" />
                <span>
                  Đăng nhập Google không hoạt động trong trình duyệt của ứng dụng này (Messenger/Instagram/Zalo/TikTok...). Vui lòng dùng <strong>Email hoặc Tên tài khoản</strong> bên dưới, hoặc mở link này bằng Safari/Chrome để dùng được Google.
                </span>
              </div>
            ) : (
              <button
