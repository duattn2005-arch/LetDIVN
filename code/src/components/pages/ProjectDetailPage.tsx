                ...
                {event.schedule && event.schedule.length > 0 ? (
                  ...
                  <>
                    <div className="p-3.5 bg-white border border-slate-200 rounded-2xl shadow-xs flex items-start gap-3.5">
                      ...
                      <span className="text-slate-800 font-medium leading-relaxed pt-0.5">
                        <EditableText contentKey="projectDetail.defaultSchedule1Activity" defaultValue="Gather at the meeting point:" as="span" /> <strong>{event.meetingPoint || event.location}</strong>, check-in and equipment distribution
                      </span>
                    </div>
                    <div className="p-3.5 bg-white border border-slate-200 rounded-2xl shadow-xs flex items-start gap-3.5">
                      <EditableText
                    ...
                    <div className="p-3.5 bg-white border border-slate-200 rounded-2xl shadow-xs flex items-start gap-3.5">
                      ...
                      <EditableText
                        ...
                        defaultValue="Cleanup begins: sorting recyclable, organic, and hazardous waste"
                        as="span"
                        className="text-slate-800 font-medium leading-relaxed pt-0.5"
                      />
                    </div>
                    <div className="p-3.5 bg-white border border-slate-200 rounded-2xl shadow-xs flex items-start gap-3.5">
                      ...
                      <EditableText
                        ...
                        defaultValue="Load waste onto the collection truck, weigh the total, group photo, and closing"
                        as="span"
                        className="text-slate-800 font-medium leading-relaxed pt-0.5"
                      />
                    </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-bold text-slate-900 flex items-center gap-2">
                  ...
                  <EditableText contentKey="projectDetail.mapTitle" defaultValue="Cleanup Meeting Point Map" as="span" />
                </h3>
                <a
          ...
          <div className="space-y-6">
            <div className="bg-slate-50 p-6 rounded-3xl border border-slate-200 space-y-5 sticky top-24">
              ...
              <div className="space-y-3 text-xs text-slate-600 pt-3 border-t border-slate-200">
                ...
                <div>👤 <strong><EditableText contentKey="projectDetail.leaderLabel" defaultValue="Team Leader:" as="span" /></strong> {event.leader}</div>
              </div>
